...
const styles = StyleSheet.create({
  ...
  budgetStatusText: { fontSize: 10, fontFamily: "Inter_600SemiBold" },
  barBg: { height: 6, borderRadius: 3, overflow: "hidden" },
  barFill: { height: "100%", borderRadius: 3 },
  budgetRemaining: { fontSize: 11, fontFamily: "Inter_400Regular" },
  catPersonRow: {
    flexDirection: "row",
    gap: 12,
    marginTop: 2,
  },
  catPersonText: { fontSize: 12, fontFamily: "Inter_400Regular" },
  emptyState: {
    alignItems: "center",
    justifyContent: "center",
    paddingTop: 80,
